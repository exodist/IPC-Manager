...
sub have_pending_responses {
    ...
    return 1 if $self->{_RESPONSES}        && grep { !defined($_) } values %{$self->{_RESPONSES}};
    return 1 if $self->{_RESPONSE_HANDLER} && grep { defined($_) } values %{$self->{_RESPONSE_HANDLER}};
    return 0;
}
...
sub get_response {
    ...
    croak "Response id '$resp_id' has a callback assigned"
